...
//go:generate minimock -i github.com/ybgr111/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, userInfo *model.UserInfo, userPassword *model.UserPassword) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, userInfo *model.UserInfo, userPassword *model.UserPassword)
	...
	funcGet          func(ctx context.Context, id int64) (up1 *model.UserPublic, err error)
	inspectFuncGet   func(ctx context.Context, id int64)
	afterGetCounter  uint64
	beforeGetCounter uint64
	GetMock          mUserServiceMockGet

	funcUpdate          func(ctx context.Context, id int64, userInfo *model.UserInfo) (err error)
	inspectFuncUpdate   func(ctx context.Context, id int64, userInfo *model.UserInfo)
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, userInfo *model.UserInfo, userPassword *model.UserPassword) *mUserServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserServiceMockCreateParams{ctx, userInfo, userPassword}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, userInfo *model.UserInfo, userPassword *model.UserPassword)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, userInfo *model.UserInfo, userPassword *model.UserPassword) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, userInfo *model.UserInfo, userPassword *model.UserPassword) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserServiceMockCreateParams{ctx, userInfo, userPassword},
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, userInfo *model.UserInfo, userPassword *model.UserPassword) (i1 int64, err error) {
	mm_atomic.AddUint64(&mmCreate.beforeCreateCounter, 1)
	defer mm_atomic.AddUint64(&mmCreate.afterCreateCounter, 1)

	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, userInfo, userPassword)
	}

	mm_params := UserServiceMockCreateParams{ctx, userInfo, userPassword}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateParams{ctx, userInfo, userPassword}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, userInfo, userPassword)
	}
	mmCreate.t.Fatalf("Unexpected call to UserServiceMock.Create. %v %v %v", ctx, userInfo, userPassword)
	return
}
...
func (mmGet *mUserServiceMockGet) Return(up1 *model.UserPublic, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id int64) (up1 *model.UserPublic, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserServiceMockGetExpectation) Then(up1 *model.UserPublic, err error) *UserServiceMock {
	e.results = &UserServiceMockGetResults{up1, err}
	return e.mock
}

// Get implements service.UserService
func (mmGet *UserServiceMock) Get(ctx context.Context, id int64) (up1 *model.UserPublic, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, id int64, userInfo *model.UserInfo) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, userInfo *model.UserInfo)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, id int64, userInfo *model.UserInfo) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, id int64, userInfo *model.UserInfo) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, id int64, userInfo *model.UserInfo) (err error) {
