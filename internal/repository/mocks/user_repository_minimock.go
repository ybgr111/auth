...
//go:generate minimock -i github.com/ybgr111/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, user *userModel.User) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, user *userModel.User)
	...
	funcUpdate          func(ctx context.Context, user *userModel.User) (err error)
	inspectFuncUpdate   func(ctx context.Context, user *userModel.User)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, user *userModel.User) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, user *userModel.User)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, user *userModel.User) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, user *userModel.User) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, user *userModel.User) (i1 int64, err error) {
...
func (mmGet *mUserRepositoryMockGet) Return(up1 *model.UserPublic, err error) *UserRepositoryMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, id int64) (up1 *model.UserPublic, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetExpectation) Then(up1 *model.UserPublic, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetResults{up1, err}
	return e.mock
}

// Get implements repository.UserRepository
func (mmGet *UserRepositoryMock) Get(ctx context.Context, id int64) (up1 *model.UserPublic, err error) {
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, user *userModel.User) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, user *userModel.User)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, user *userModel.User) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, user *userModel.User) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, user *userModel.User) (err error) {
